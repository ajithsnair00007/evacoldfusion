...
<cfcomponent>
   ...
   <cffunction  name="retrieveCoupon" access="remote" returntype="string" returnformat="json">
     <cfargument  name="id" type="numeric" required="true">
      ...
      <cffunction  name="applyCouponIdToCart" access="remote" returntype="string" returnformat="json">
      <cfargument  name="cartCouponId" type="numeric">
      <cfargument  name="id" type="numeric" required="true">
   ...
   <cffunction name="applyCoupon" access="remote" returntype="string" returnformat="json">
      ...
      <cfargument  name="id" type="numeric" required="true">
        ...
        <cfset currentdate = dateFormat(now(),"YYYY-MM-DD")>
         ...
         <cfif retrievecouponapplieddate.RecordCount eq 0>
            <cfquery name="accesscoupondetails" datasource="product_list">
               SELECT coupon_id,coupon_code,coupon_type,coupon_offer FROM coupons
               WHERE coupon_name = <cfqueryparam value="#arguments.selectedOffer#" cfsqltype="cf_sql_varchar"> 
            </cfquery>
   ...
   <cffunction  name="applyDiscountToCart" access="remote" returntype="string" returnformat="json">
     <cfargument  name="cartDiscount" type="string">
     <cfargument  name="id" type="numeric" required="true">
...
<!---          </cfif> --->
   ...
   <cffunction  name="restrictApplyCoupon" access="remote" returntype="string" returnformat="json"> 
      ...
      <cfset dateOfToday = dateFormat(currentDate,"YYYY-MM-DD")>
      <cfset response['CURRENTDATE']= dateOfToday>
      <cfquery name="retrieveCouponApplyDate" datasource="product_list">
         SELECT * FROM orders
         WHERE couponAppliedOn = <cfqueryparam value="#dateOfToday#" cfsqltype="cf_sql_date">
      </cfquery>

      <cfif retrieveCouponApplyDate.RecordCount>
         <cfset couponAppliedDate = retrieveCouponApplyDate.couponAppliedOn>
         <cfset appliedDate = dateFormat(couponAppliedDate,"YYYY-MM-DD")>
         <cfset response['CPAPPLIEDDATE'] = appliedDate>
      </cfif>
